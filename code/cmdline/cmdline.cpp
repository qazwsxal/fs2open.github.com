...
cmdline_parm emissive_power_arg("-emissive", "Adds light to all objects", AT_FLOAT);
...
cmdline_parm emissive_arg("-emissive_light", "Enable emissive light from ships, use -emissive for configurable brightness", AT_NONE);		// Cmdline_no_emissive  -- don't use emissive light in OGL
